...
package video_mode_pkg is
  ...
  constant MODE_800x600p60   : std_logic_vector(3 downto 0) := "1111";
  ...
  component video_mode is
    port (
      ...
      h_sync    : out   std_logic_vector(7 downto 0);
...
entity video_mode is
  port (
    ...
    h_sync    : out   std_logic_vector(7 downto 0);  -- horizontal sync width
...
architecture synth of video_mode is
  ...
  type video_timings_t is array (0 to 15) of video_timing_t;
  ...
  (
    ...
    (
      ...
      dmt       => true,
      id        => 9,
      -- This build uses a fixed 40 MHz video clock.  The selector value is
      -- retained only for interface compatibility with video_out_clock.
      clk_sel   => CLK_SEL_25M2,
      pix_rep   => 0,
      aspect    => ASPECT_4_3,
      interlace => FALSE,
