...
package video_out_timing_pkg is
  ...
  component video_out_timing is
    ...
    port (
      ...
      h_sync    : in    std_logic_vector(7 downto 0);
...
entity video_out_timing is
  ...
  port (
    ...
    h_sync    : in    std_logic_vector(7 downto 0);  -- 1..255
...
architecture synth of video_out_timing is
  ...
  signal h_sync_s       : std_logic_vector(7 downto 0);  -- }
...
begin
  ...
  SYNC : component sync_reg
    ...
    port map (
      ...
      d(14 downto 8)  => h_sync(6 downto 0),
      d(7 downto 0)   => h_bp,
      q(72)           => h_sync_s(7),
      q(71)           => genlock_s,
      q(70)           => pix_rep_s,
      ...
      q(14 downto 8)  => h_sync_s(6 downto 0),
      q(7 downto 0)   => h_bp_s
    );
